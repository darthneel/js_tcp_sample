...
module.exports.add = function (client, clientRequestArray, todos) {
...
module.exports.completed = function (client, clientRequestArray, todos) {
...
module.exports.list = function (client, todos) {
...
module.exports.help = function (client) {
